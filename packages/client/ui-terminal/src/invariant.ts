...
/**
 * No runtime invariant: this package is a presentation viewport over the
 * Host terminal attach API and mux chunk frames. Dock open/tab state is local
 * UI viewing state, not an authoritative cordis event stream.
 */
