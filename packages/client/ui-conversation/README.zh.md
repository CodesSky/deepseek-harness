...
- **overlay 标题栏的 inset 与拖拽区只存在于 Tauri 壳**：`dsh web` 与 `--browser-launcher` 保持齐平，且不会收到 `data-tauri-drag-region`（[决策](../../../.agents/notes/implemented/feature/2026-08-15-macos-immersive-title-bar.md)）。
