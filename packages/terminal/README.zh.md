...
设计与暂缓边界记录在[持久 PTY Agent Note](../../.agents/notes/implemented/feature/2026-07-16-persistent-pty-sessions.md) 中。随附的 `standard`／`code`／`cordis` agent preset 在 Linux 与 macOS 上挂载该家族；`minimal` 改用单工具持久 bash 消费方。
